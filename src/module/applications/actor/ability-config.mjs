 ...
 * @param {string} abilityId            The ability key as defined in CONFIG.ANAT.abilities.
 */
export default class ActorAbilityConfig extends BaseConfigSheet {
  ...
  static get defaultOptions() {
    return foundry.utils.mergeObject(super.defaultOptions, {
      classes: ["dnd5e"],
      template: "systems/anatrpg/templates/apps/ability-config.hbs",
      width: 500,
      height: "auto"
    });
  }
  ...
  get title() {
    return `${game.i18n.format("DND5E.AbilityConfigureTitle", {
      ability: CONFIG.ANAT.abilities[this._abilityId].label})}: ${this.document.name}`;
  }
  ...
  getData(options) {
    ...
    const ability = CONFIG.ANAT.abilities[this._abilityId].label;
    return {
      ...
      proficiencyLevels: {
        0: CONFIG.ANAT.proficiencyLevels[0],
        1: CONFIG.ANAT.proficiencyLevels[1]
      },
